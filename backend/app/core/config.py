...
class Settings(BaseSettings):
    ...
    app_port: int = 8000
    cors_origins: List[str] = ["http://localhost:3000", "http://localhost:5173", "https://frontend-81rdtgomo-siris-projects-3809a50.vercel.app", "https://frontend-eqzjr0em9-siris-projects-3809a50c.vercel.app"]
